...
export const LightGuide = () => {
  ...
  return (
    <Box>
      <Input
        type="file"
        className="UploadConfigFile"
        ref={configFileInputRef}
        display="none"
        onChange={handleConfigFileChange}
      />
      <Button className="UploadButton" onClick={handleConfigClick}>
        {configFile ? "Config File Selected" : "Select Config File"}
      </Button>
      <Input
        type="file"
      ...
      />
      <Button className="UploadButton" onClick={handleInputClick}>
        {inputFile ? "Input File Selected" : "Select Input File"}
      </Button>
      <Button
        className="UploadButton"
        onClick={handleUpload}
        disabled={!configFile || !inputFile}
      >
        Upload
      </Button>
    </Box>
